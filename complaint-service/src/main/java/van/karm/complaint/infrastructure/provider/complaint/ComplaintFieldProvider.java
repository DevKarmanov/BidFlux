...
@Component
@Qualifier("complaint-field-provider")
public class ComplaintFieldProvider implements AllowedFieldsProvider {
    private static final Set<String> ALLOWED_USER_FIELDS = Set.of(
            "id", "authorId", "targetType","targetId","reason","description","status","createdAt"
    );
